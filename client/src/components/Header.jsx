              ...
              {path === "create-post" ? (
                <div className="flex align-center">
                  ...
                  <button
                    ...
                    type="button"
                    className="md:hidden bg-gray-800 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none"
