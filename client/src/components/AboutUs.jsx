    ...
    return (
        <section className="min-h-[800px] w-full text-white py-10 pb-20">
            ...
            <div className=" border rounded-lg border-zinc-500 mt-8 text-left inter w-[80%] mx-auto py-10">
                ...
                <h2 className="px-40 font-bold text-gray-500 text-3xl pt-10 pb-3"><span className="text-4xl text-red-700">1.</span> Who are we?</h2>
                <p className="px-40 text-zinc-500">We are ImaginAIry, a community-driven platform that harnesses the power of artificial intelligence to help people transform their ideas into visual art. We are passionate about enabling creativity through technology and providing a space for users to explore, create, and share AI-generated images.</p>
                <h2 className="px-40 font-bold text-gray-500 text-3xl pt-10 pb-3"><span className="text-4xl text-red-700">2.</span> What do we do?</h2>
                <p className="px-40 text-zinc-500">At ImaginAIry, we provide a unique platform where users can input prompts and generate stunning images using AI. Once created, users can customize their image with their name as the author and share it on our platform. We offer an 'Explore' section where everyone can browse through a variety of creative works, and each image is available for download. Our mission is to inspire creativity, foster collaboration, and make AI-generated art accessible to all.</p>
            </div>
